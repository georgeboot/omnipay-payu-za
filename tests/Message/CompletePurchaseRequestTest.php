...
class CompletePurchaseRequestTest extends TestCase
{
    ...
    public function testCompletePurchaseItnSuccess()
    {
        ...
        $this->assertInstanceOf('Omnipay\PayUZa\Message\CompletePurchaseItnResponse', $response);
    ...
    public function testCompletePurchasePdtSuccess()
    {
        ...
        $this->assertInstanceOf('Omnipay\PayUZa\Message\CompletePurchasePdtResponse', $response);
        $this->assertFalse($response->isSuccessful());
        $this->assertFalse($response->isRedirect());
        $this->assertNull($response->getTransactionReference());
